...
var secretA = brandA("This is a secret value");
var secretB = brandB({ abc: "This is a different secret value" });
// secretA = secretB; 
// unbrandB(secretA);
// unbrandA(secretB);
var revealedA = unbrandA(secretA);
var revealedB = unbrandB(secretB);
//BOTTOM TYPE: never
// let n: never = 4;
var x = "abc";
if (typeof x === "string") {
